...
Eighty-nine directional candidate tests are retained in the cumulative ledger. No V20–V36 candidate passed every registered discovery, temporal-validation, yearly-consistency, cost, and information-ratio gate. Formula-new confirmation bucket F therefore remains sealed.
...
| Look-elsewhere effect | Addressed with a cumulative 89-test family and retained failures, not erased. |
