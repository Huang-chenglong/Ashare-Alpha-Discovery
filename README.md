...
项目累计记录 90 个方向性候选检验。V19 曾通过研究样本，但在一次性资产隔离确认集 D 上方向失效，因此正式作废。V20–V37 在公式新鲜的开发样本 E 上继续研究；没有候选通过完整研究门槛，所以确认集 F 始终未被打开。
...
- [完整研究账本](docs/research_ledger_v7_v37.md)
- [V32–V37 专业财务数据与因子审计](docs/financial_factors_v32_v37.md)
- [统计与偏差审计](docs/statistical_audit.md)
- [90 个候选统一表](results/all_candidate_tests.csv)
